...
export type GetPermitStatusInput = z.infer<typeof GetPermitStatusInputSchema>;
export type GetCountyRequirementsInput = z.infer<
  typeof GetCountyRequirementsInputSchema
>;
export type GetPermitDocumentsInput = z.infer<
  typeof GetPermitDocumentsInputSchema
>;
export type SubmitPermitPackageInput = z.infer<
  typeof SubmitPermitPackageInputSchema
>;
